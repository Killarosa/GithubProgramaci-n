...
author: "tanya Sarango Jumbo"    # Autor del documento
...
output: # Sección que define el formato de salida del documento
  ...
  html_document: # Indica que el documento de salida será en formato HTML
    ...
    theme: journal  # Aplica el tema visual 'cerulean' al HTML (colores, fuentes, etc., otros pueden ser journal,flatly, etc. )
...
# Vista previa
# Es para que se vea bien y esteticamente quede más amigable
